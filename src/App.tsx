  ...
  return (
    ...
    <div className={`min-h-screen ${isLight ? "light bg-slate-50 text-slate-900" : "bg-slate-950 text-slate-100"} flex flex-col justify-between font-sans selection:bg-amber-400 selection:text-slate-950 maritime-grid shipping-lanes`
      ...
      <div className="lg:hidden bg-blue-[980] bg-[#070e1b] border-b border-blue-900/30 sticky top-[71px] z-40 px-3 py-2 flex items-center justify-between shadow-md overflow-x-auto gap-1" >
        <button
          onClick={() => setActiveTab("home")}
          className={`text-xs px-2.5 py-2 font-bold rounded-lg shrink-0 cursor-pointer transition-all ${activeTab === "home" ? "bg-amber-400/20 text-amber-300 border border-amber-400/30" : "text-slate-300 hover:bg-white/5"
            }`}
        >
          {isAr ? "الرئيسية" : "Home"}
        </button>
        <button
          onClick={() => setActiveTab("about")}
          className={`text-xs px-2.5 py-2 font-bold rounded-lg shrink-0 cursor-pointer transition-all ${activeTab === "about" ? "bg-amber-400/20 text-amber-300 border border-amber-400/30" : "text-slate-300 hover:bg-white/5"
            }`}
        >
        ...
        <button
          onClick={() => setActiveTab("encyclopedia")}
          className={`text-xs px-2.5 py-2 font-bold rounded-lg shrink-0 cursor-pointer transition-all ${activeTab === "encyclopedia" ? "bg-amber-400/20 text-amber-300 border border-amber-400/30" : "text-slate-300 hover:bg-white/5"
            }`}
        >
        ...
        <button
          onClick={() => setActiveTab("calculator")}
          className={`text-xs px-2.5 py-2 font-bold rounded-lg shrink-0 cursor-pointer transition-all ${activeTab === "calculator" ? "bg-amber-400/20 text-amber-300 border border-amber-400/30" : "text-slate-300 hover:bg-white/5"
            }`}
        >
          {isAr ? "الحاسبة" : "Calc"}
        </button>
        <button
          onClick={() => setActiveTab("chat")}
          className={`text-xs px-2.5 py-2 font-bold rounded-lg shrink-0 cursor-pointer transition-all ${activeTab === "chat" ? "bg-amber-400/20 text-amber-300 border border-amber-400/30" : "text-slate-300 hover:bg-white/5"
            }`}
        >
        ...
        <button
          onClick={() => setActiveTab("tracker")}
          className={`text-xs px-2.5 py-2 font-bold rounded-lg shrink-0 cursor-pointer transition-all ${activeTab === "tracker" ? "bg-amber-400/20 text-amber-300 border border-amber-400/30" : "text-slate-300 hover:bg-white/5"
            }`}
        >
        ...
        <button
          onClick={() => setActiveTab("booking")}
          className={`text-xs px-2.5 py-2 font-bold rounded-lg shrink-0 cursor-pointer transition-all ${activeTab === "booking" ? "bg-amber-400/20 text-amber-300 border border-amber-400/30" : "text-slate-300 hover:bg-white/5"
            }`}
        >
